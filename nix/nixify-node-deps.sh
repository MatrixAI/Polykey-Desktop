...
# POLYKEY_SRC_URL_OVERRIDE="https://github.com/MatrixAI/PolyKey/archive/905eb0e329cbf040c684b1077eeecaa5c28fe669.tar.gz"

if [[ "x" = "${POLYKEY_SRC_URL_OVERRIDE+x}" ]]; then
