<template>
  <div :class="['flex flex-col h-full', showDrawer ? 'block' : 'hidden']">
    ...
    <div class="flex-grow p-6">
      ...
      <div>
        You can either add a Keynode by pasting the public key of a keynode or adding through a digital identity proof.
      </div>
      ...
      <div class="mt-2">
        <a-textarea @input="updatePublicKey" class="rounded" placeholder="Paste public key" />
      </div>
      ...
      <div class="flex mt-2">
        ...
        <div><a-input @input="updateUsername" class="rounded" placeholder="Enter username" /></div>
      </div>
    ...
    <div class="px-5 py-8">
      Once a keynode trusts you, you should be able to pull secrets from their vaults quickly and easily.
    </div>
  </div>
</template>
<script>
