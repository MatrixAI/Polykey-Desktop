...
class PolykeyClient {
  ...
  static async AddPeerB64(peerInfoB64: string): Promise<string> {
    const res = pb.StringMessage.deserializeBinary(await ipcRenderer.invoke('AddPeerB64', peerInfoB64));
    return res.getS();
  }

  static async AuthenticateProvider(request: pb.AuthenticateProviderRequest.AsObject): Promise<string> {
    const encodedRequest = new pb.AuthenticateProviderRequest();
    encodedRequest.setProviderKey(request.providerKey);
    const res = pb.StringMessage.deserializeBinary(
      await ipcRenderer.invoke('AuthenticateProvider', encodedRequest.serializeBinary())
    );
    return res.getS();
  }

  static async AugmentKeynode(request: pb.AugmentKeynodeRequest.AsObject): Promise<string> {
    const encodedRequest = new pb.AugmentKeynodeRequest();
    encodedRequest.setProviderKey(request.providerKey);
    encodedRequest.setIdentityKey(request.identityKey);
    const res = pb.StringMessage.deserializeBinary(
      await ipcRenderer.invoke('AugmentKeynode', encodedRequest.serializeBinary())
    );
    return res.getS();
  }
  ...
  static async DeleteSecret(request: pb.SecretPathMessage.AsObject): Promise<void> {
  ...
  static async FindPeer(request: pb.ContactNodeMessage.AsObject): Promise<void> {
  ...
  static async FindSocialPeer(request: pb.ContactNodeMessage.AsObject): Promise<string[]> {
    const encodedRequest = new pb.ContactNodeMessage();
    encodedRequest.setPublicKeyOrHandle(request.publicKeyOrHandle);
    encodedRequest.setTimeout(request.timeout);
  ...
  static async GetLocalPeerInfo(): Promise<pb.NodeInfoMessage.AsObject> {
    const res = pb.NodeInfoMessage.deserializeBinary(await ipcRenderer.invoke('GetLocalPeerInfo'));
    return res.toObject();
  }

  static async GetPeerInfo(peerId: string): Promise<pb.NodeInfoMessage.AsObject> {
    const encodedRequest = new pb.StringMessage();
  ...
  static async GetConnectedIdentityInfos(request: pb.ProviderSearchMessage.AsObject, callback): Promise<void> {
    ...
    await ipcRenderer.send('GetConnectedIdentityInfos-message', encodedRequest.serializeBinary());
  }

  static async DiscoverGestaltIdentity(request: pb.IdentityMessage.AsObject, callback): Promise<void> {
    const encodedRequest = new pb.IdentityMessage();
    console.log('discovering', request.key);
    encodedRequest.setKey(request.key);
    encodedRequest.setProviderKey(request.providerKey);

    await ipcRenderer.send('DiscoverGestaltIdentity-message', encodedRequest.serializeBinary());
  ...
  static async GetIdentityInfo(request: pb.EmptyMessage.AsObject): Promise<any> {
    const encodedRequest = new pb.EmptyMessage();
    const res = pb.IdentityInfo.deserializeBinary(
      await ipcRenderer.invoke('GetIdentityInfo', encodedRequest.serializeBinary())
    );
    return res.getKey();
  }

  static async GetGestaltByIdentity(request: pb.IdentityMessage.AsObject): Promise<any> {
    const encodedRequest = new pb.IdentityMessage();
    encodedRequest.setProviderKey(request.providerKey);
    encodedRequest.setKey(request.key);
    const res = pb.GestaltMessage.deserializeBinary(
      await ipcRenderer.invoke('GetGestaltByIdentity', encodedRequest.serializeBinary())
    );
    // return {
  ...
  static async TrustGestalt(request: pb.StringMessage.AsObject): Promise<string> {
    const encodedRequest = new pb.StringMessage();
    encodedRequest.setS(request.s);
    const res = pb.StringMessage.deserializeBinary(
      await ipcRenderer.invoke('TrustGestalt', encodedRequest.serializeBinary())
    );
    return res.getS();
  }

  static async UntrustGestalt(request: pb.StringMessage.AsObject): Promise<string> {
    const encodedRequest = new pb.StringMessage();
    encodedRequest.setS(request.s);
    const res = pb.StringMessage.deserializeBinary(
      await ipcRenderer.invoke('UntrustGestalt', encodedRequest.serializeBinary())
    );
    return res.getS();
  }

  static async GestaltIsTrusted(request: pb.StringMessage.AsObject): Promise<string> {
    const encodedRequest = new pb.StringMessage();
    encodedRequest.setS(request.s);
    const res = pb.StringMessage.deserializeBinary(
      await ipcRenderer.invoke('GestaltIsTrusted', encodedRequest.serializeBinary())
    );
    return res.getS();
  }
  ...
  static async InitializeKeyNode(request: pb.NewKeyPairMessage.AsObject): Promise<void> {
    const encodedRequest = new pb.NewKeyPairMessage();
    encodedRequest.setPassphrase(request.passphrase);
    const res = pb.EmptyMessage.deserializeBinary(
      await ipcRenderer.invoke('InitializeKeyNode', encodedRequest.serializeBinary())
    );
    return;
  }

  static async NewSecret(request: pb.SecretContentMessage.AsObject): Promise<void> {
  ...
  static async PingPeer(request: pb.ContactNodeMessage.AsObject): Promise<void> {
    const encodedRequest = new pb.ContactNodeMessage();
    encodedRequest.setPublicKeyOrHandle(request.publicKeyOrHandle);
    encodedRequest.setTimeout(request.timeout);
  ...
  static async UnlockNode(request: pb.UnlockNodeMessage.AsObject): Promise<void> {
  ...
  static async UpdateLocalPeerInfo(request: pb.NodeInfoMessage.AsObject): Promise<void> {
    const encodedRequest = new pb.NodeInfoMessage();
    encodedRequest.setPublicKey(request.publicKey);
    if (request.nodeAddress !== '') {
      encodedRequest.setNodeAddress(request.nodeAddress);
  ...
  static async UpdatePeerInfo(request: pb.NodeInfoMessage.AsObject): Promise<void> {
    const encodedRequest = new pb.NodeInfoMessage();
    encodedRequest.setPublicKey(request.publicKey);
    if (request.nodeAddress !== '') {
      encodedRequest.setNodeAddress(request.nodeAddress);
  ...
  static async UpdateSecret(request: pb.SecretContentMessage.AsObject): Promise<void> {
    const encodedRequest = new pb.SecretContentMessage();
    const secretPathMessage = new pb.SecretPathMessage();
    secretPathMessage.setVaultName(request.secretPath!.vaultName);
    secretPathMessage.setSecretName(request.secretPath!.secretName);
  ...
  static async VerifyFile(request: pb.VerifyFileMessage.AsObject): Promise<void> {
